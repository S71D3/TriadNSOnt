...
namespace TriadNSim.Forms
{
    public partial class frmMain : Form
    {
        ...
        private void LoadElements()
        {
           ...
           string[] standartItems = { "Рабочая станция", "Сервер", "Маршрутизатор", "Пользовательский", "Узел", "Станция", "Робот-пылесос"};
           //string[] standartItems = { "Workstation", "Server", "Router", "Custom" };
            string[] standartItemNames = { "Workstation", "Server", "Router", "ComputerNetworkNode", "SDNNode", "Robot", "Robot"};
            ENetworkObjectType[] types = { ENetworkObjectType.Client, ENetworkObjectType.Server, ENetworkObjectType.Undefined, ENetworkObjectType.UserObject, ENetworkObjectType.Undefined, ENetworkObjectType.Undefined, ENetworkObjectType.Undefined };
